...
- Nextjs (App Router), MongoDB (Mongoose), TailwindCSS, sass (SSR & Optimised Perfomence useTurbopack if you can), use bun & bunx for Package Manager or Script Run
- use Current folder as workpace
...
- Database URL add it on Env i have alrady install mongoDB on my device so you no need to worry about that
